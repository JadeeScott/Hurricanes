...
for n, m, y, ms, a, da, z in zip(names, months, years, max_sustained_winds, areas_affected, updated_damages, deaths):
    year_dict = {y: {"Name": n, "Month": m, "Max_sustained_winds": ms, "Area_affected": a, "Updated_damages": da, "Deaths": z}}
    year.append(year_dict)
...
max_area, max_count = max_affected_areas(areas_count)

#print(max_area, max_count)

# write your greatest number of deaths function here:
def deaths(hurricanes):
  hurricane_most_deaths = ''
  number_of_deaths = 0

  for hurricane in hurricanes:
    if hurricane[hurricane]['Deaths'] > number_of_deaths:
      hurricane_most_deaths = hurricane
      number_of_deaths = hurricanes[hurricane]['Deaths']
      return number_of_deaths, hurricane_most_deaths
  
number_of_deaths, most_deaths = deaths(hurricanes)

#print(number_of_deaths, most_deaths)
